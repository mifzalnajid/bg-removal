...
const Testmonial = () => {
    return (
        <div>
            {/* ----------------------Title---------------------- */}
            <h1 className='text-center text-2xl md:text-3xl py-5 lg:text-4xl mt-4 font-semibold bg-gradient-to-r from-gray-900 to-gray-400 bg-clip-text text-transparent'>
