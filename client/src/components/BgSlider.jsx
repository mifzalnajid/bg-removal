...
const BgSlider = () => {
    ...
    return (
        <div className='pb-10 md:py-20 mx-2'>
            <h1 className=' sm:mb-20 text-center text-2xl md:text-3xl lg:text-4xl mt-4 mb-12 font-semibold bg-gradient-to-r from-gray-900 to-gray-400 bg-clip-text text-transparent'>
